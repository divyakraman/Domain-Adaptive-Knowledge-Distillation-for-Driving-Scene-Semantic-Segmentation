...
#from model.drncd_multi import * 
from model.drnd38_multi_feature7 import *
...
ITER_SIZE = 1
NUM_WORKERS = 1
one_up = osp.abspath(osp.join(os.getcwd(),".."))
DATA_DIRECTORY = 'path'
...
IGNORE_LABEL = 255
INPUT_SIZE_TARGET = '512,1024' #1024,2048
...
SAVE_NUM_IMAGES = 2
SAVE_PRED_EVERY = 100
SNAPSHOT_DIR = './snapshots/gta2cs_multi_drnd38_feature7/'
WEIGHT_DECAY = 0.0005
